...
Add-AppxPackage -register "C:\Program Files\WindowsApps\Microsoft.WebMediaExtensions_1.0.33271.0_x86__8wekyb3d8bbwe\AppxManifest.xml" -DisableDevelopmentMode
