...
1) Stop all brousers and run script step1.ps1 as Administrator. Or run commands in powershell.exe line by line.
...
1) Выключите все браузеры и запустите скрипт step1.ps1 от Администратора. Либо запускайте в powershell.exe команды построчно.
